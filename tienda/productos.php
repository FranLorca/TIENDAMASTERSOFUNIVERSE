<div class="portfolio-modal modal fade" id="<?php echo $valor2->getReferencia();?>" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted"><?php echo $valor2->getPrecio();?></p>
                                ...
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, 
                                    consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                                <p>
  ...
  <fieldset>
    ...
    <ul>
      ...
      <li><?php echo $valor2->getPrecio();?></li>
      <li>
        <label>Cantidad: <input type="text" name="my-item-qty" value="1" size="3" /></label>
      </li>
    </ul>

    <input type="submit" class="btn btn-primary" name="my-add-button" value="añadir al carrito" class="button" />
  </fieldset>
</form>
                            </div>
                        </div>
